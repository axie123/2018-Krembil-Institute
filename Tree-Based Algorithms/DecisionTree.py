...
# The standardized and the validated interactions in the training set are loaded.
...
# Splicing and Trimming the dataset for machine learning.
...
# Turning multi-class labels into binary.
...
tree = DecisionTreeRegressor(max_depth = 800, criterion = 'friedman_mse', min_samples_leaf = 15, random_state = 1) # lr max_leaf_nodes = 100000000,
